...
public class KerkoMbajtesiteLibritController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		DataMarrjes.setCellValueFactory(new PropertyValueFactory<>("DataMarrjesNew"));
		DataKthimit.setCellValueFactory(new PropertyValueFactory<>("DataKthimitNew"));
		...
		filterField.textProperty().addListener((observable, oldValue, newValue) -> {
			filteredData.setPredicate(BookHolders -> {
				...
				} else if (String.valueOf(BookHolders.getDataMarrjesNew()).indexOf(lowerCaseFilter) != -1) {
					return true; // Filteri perputhet me getkDataMarrjes.
				} else if (String.valueOf(BookHolders.getDataKthimitNew()).indexOf(lowerCaseFilter) != -1) {
