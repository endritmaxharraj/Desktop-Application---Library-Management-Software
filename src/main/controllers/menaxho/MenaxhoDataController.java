package main.controllers.menaxho;
...
public class MenaxhoDataController implements Initializable {
	double x, y;
	...
	@FXML
	private void updateDataClicked(ActionEvent event) throws Exception {
	...
	@FXML
	private void deleteDataClicked(ActionEvent event) throws Exception {
		FXMLLoader loader = new FXMLLoader();
