...
public class DeleteBookController implements Initializable {
	...
	private void check() throws Exception {
		if (emriLibritAutoriField.getText().isEmpty() || vitiBotimitField.getText().isEmpty()
	...
	private void deleteBook(String EmriLibritAutori) throws Exception {
		Connection con = DBConnector.getConnection();
		String sql = "DELETE FROM RegjistrimiLibrave WHERE Emri_Librit_Autori = ?";
	...
	private void delete() throws Exception {
		try {
			Librat librat = tableview.getSelectionModel().getSelectedItem();
			deleteBook(librat.getEmriLibritAutori());
			tableview.getSelectionModel().clearSelection();
			tableview.getItems().remove(librat);
