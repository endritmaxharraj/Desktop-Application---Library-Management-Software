...
public class RegisterVendetEditKatiPareController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		ObservableList<String> sektoriList = FXCollections.observableArrayList("Kati i pare");
	...
	private void regjistroButtonClicked(ActionEvent event) throws Exception {
		...
		if (emriMbiemriField.getText().isEmpty()
			...
			if (!rs.next()) {
				labSuccess.setText("Lexuesi me kete Emer dhe mbiemer '"
						+ emriMbiemriField.getText()
	...
	private void back(MouseEvent event) throws IOException {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(getClass().getResource("../../views/register/registerVendetKatiPare.fxml"));
		loader.load();
		Parent parent = loader.getRoot();
		Scene scene = new Scene(parent);
		Stage primaryStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
