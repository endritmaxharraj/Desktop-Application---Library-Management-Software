...
public class RegisterVendetKatiDyteController implements Initializable {
	double x, y;
	...
	private void button1Clicked(ActionEvent event) throws IOException {
		...
		loader.setLocation(getClass().getResource("../../views/register/registerVendetEditKatiDyte.fxml"));
		loader.load();

		String getButtonText = ((Button) event.getSource()).getText();

		RegisterVendetEditKatiDyteController editController = loader.getController();
